...
import codecs
import json
import knp_word2vecdetect
from gensim.models import word2vec
path = "/home/pau/workspace/Environment_BD/Unfounded/word2vecModel/"
#fname = path + "aozora_default.model"
...
def writeconclusion(data,model):   
    conclusion = knp_word2vecdetect.Detect(data["utterance"],model)
        ...
        for i,f in enumerate(jsonFiles):
            ...
            for data in jsonData["turns"]:
                ...
                if(turnIndex%2 == 0 and turnIndex != 0):
                    ...
                    conclusion = writeconclusion(data,model)
